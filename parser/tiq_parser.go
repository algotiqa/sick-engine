...
func tiqparserParserInit() {
	staticData := &TiqParserParserStaticData
...
// TiqParserInit initializes any static state used to implement TiqParser. By default the
// static state used to implement the parser is lazily initialized during the first call to
// NewTiqParser(). You can call this function if you wish to initialize the static state ahead
// of time.
func TiqParserInit() {
	staticData := &TiqParserParserStaticData
	staticData.once.Do(tiqparserParserInit)
}
...
func NewTiqParser(input antlr.TokenStream) *TiqParser {
	...
	this.GrammarFileName = "TiqParser.g4"
...
func NewEmptyScriptContext() *ScriptContext {
	...
	p.RuleIndex = TiqParserRULE_script
	return p
}
...
func (s *ScriptContext) EnterRule(listener antlr.ParseTreeListener) {
	if listenerT, ok := listener.(TiqParserListener); ok {
...
func (p *TiqParser) Script() (localctx IScriptContext) {
	...
	p.EnterRule(localctx, 0, TiqParserRULE_script)
	var _la int
...
func NewEmptyPackageDefContext() *PackageDefContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = TiqParserRULE_packageDef
	return p
}
...
func (s *PackageDefContext) PACKAGE() antlr.TerminalNode {
	return s.GetToken(TiqParserPACKAGE, 0)
}

func (s *PackageDefContext) IDENTIFIER() antlr.TerminalNode {
	return s.GetToken(TiqParserIDENTIFIER, 0)
}
...
func (p *TiqParser) PackageDef() (localctx IPackageDefContext) {
	...
	p.EnterRule(localctx, 2, TiqParserRULE_packageDef)
	p.EnterOuterAlt(localctx, 1)
	{
		p.SetState(109)
		p.Match(TiqParserPACKAGE)
		if p.HasError() {
...
func NewEmptyConstantsDefContext() *ConstantsDefContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = TiqParserRULE_constantsDef
	return p
}
...
func (s *ConstantsDefContext) CONST() antlr.TerminalNode {
	return s.GetToken(TiqParserCONST, 0)
}

func (s *ConstantsDefContext) L_CURLY() antlr.TerminalNode {
	return s.GetToken(TiqParserL_CURLY, 0)
}

func (s *ConstantsDefContext) R_CURLY() antlr.TerminalNode {
	return s.GetToken(TiqParserR_CURLY, 0)
}
...
func (p *TiqParser) ConstantsDef() (localctx IConstantsDefContext) {
	...
	p.EnterRule(localctx, 4, TiqParserRULE_constantsDef)
	var _la int

	p.EnterOuterAlt(localctx, 1)
	{
		p.SetState(112)
		p.Match(TiqParserCONST)
		if p.HasError() {
			// Recognition error - abort rule
			goto errorExit
		}
	...
	switch p.GetTokenStream().LA(1) {
	case TiqParserL_CURLY:
		{
			p.SetState(113)
			p.Match(TiqParserL_CURLY)
			if p.HasError() {
				// Recognition error - abort rule
				goto errorExit
			}
...
func NewEmptyConstantDefContext() *ConstantDefContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = TiqParserRULE_constantDef
	return p
}
...
func (s *ConstantDefContext) EQUAL() antlr.TerminalNode {
	return s.GetToken(TiqParserEQUAL, 0)
}
...
func (p *TiqParser) ConstantDef() (localctx IConstantDefContext) {
	...
	p.EnterRule(localctx, 6, TiqParserRULE_constantDef)
	p.EnterOuterAlt(localctx, 1)
	{
		p.SetState(124)
		p.Match(TiqParserIDENTIFIER)
...
func NewEmptyVariablesDefContext() *VariablesDefContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = TiqParserRULE_variablesDef
	return p
}
...
func (s *VariablesDefContext) VAR() antlr.TerminalNode {
	return s.GetToken(TiqParserVAR, 0)
}
...
func (p *TiqParser) VariablesDef() (localctx IVariablesDefContext) {
	...
	p.EnterRule(localctx, 8, TiqParserRULE_variablesDef)
	var _la int

	p.EnterOuterAlt(localctx, 1)
	{
		p.SetState(128)
		p.Match(TiqParserVAR)
		if p.HasError() {
			// Recognition error - abort rule
			goto errorExit
		}
...
func NewEmptyVariableDefContext() *VariableDefContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = TiqParserRULE_variableDef
	return p
}
...
func (p *TiqParser) VariableDef() (localctx IVariableDefContext) {
	...
	p.EnterRule(localctx, 10, TiqParserRULE_variableDef)
	p.EnterOuterAlt(localctx, 1)
	{
		p.SetState(140)
		p.Match(TiqParserIDENTIFIER)
...
func NewEmptyFunctionDefContext() *FunctionDefContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = TiqParserRULE_functionDef
	return p
}
...
func (s *FunctionDefContext) FUNC() antlr.TerminalNode {
	return s.GetToken(TiqParserFUNC, 0)
}
...
func (p *TiqParser) FunctionDef() (localctx IFunctionDefContext) {
	...
	p.EnterRule(localctx, 12, TiqParserRULE_functionDef)
	var _la int

	p.EnterOuterAlt(localctx, 1)
	{
		p.SetState(144)
		p.Match(TiqParserFUNC)
		if p.HasError() {
			// Recognition error - abort rule
			goto errorExit
		}
...
func NewEmptyClassContext() *ClassContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = TiqParserRULE_class
	return p
}
...
func (s *ClassContext) L_PAREN() antlr.TerminalNode {
	return s.GetToken(TiqParserL_PAREN, 0)
}
...
func (s *ClassContext) R_PAREN() antlr.TerminalNode {
	return s.GetToken(TiqParserR_PAREN, 0)
}
...
func (p *TiqParser) Class() (localctx IClassContext) {
	...
	p.EnterRule(localctx, 14, TiqParserRULE_class)
	p.EnterOuterAlt(localctx, 1)
	{
		p.SetState(155)
		p.Match(TiqParserL_PAREN)
		if p.HasError() {
			// Recognition error - abort rule
			goto errorExit
		}
...
func NewEmptyParametersContext() *ParametersContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = TiqParserRULE_parameters
	return p
}
...
func (s *ParametersContext) AllCOMMA() []antlr.TerminalNode {
	return s.GetTokens(TiqParserCOMMA)
}

func (s *ParametersContext) COMMA(i int) antlr.TerminalNode {
	return s.GetToken(TiqParserCOMMA, i)
}
...
func (p *TiqParser) Parameters() (localctx IParametersContext) {
	...
	p.EnterRule(localctx, 16, TiqParserRULE_parameters)
	var _la int
	...
	if _la == TiqParserIDENTIFIER {
		...
		for _la == TiqParserCOMMA {
			{
				p.SetState(161)
				p.Match(TiqParserCOMMA)
				if p.HasError() {
					// Recognition error - abort rule
					goto errorExit
				}
...
func NewEmptyParameterDeclContext() *ParameterDeclContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = TiqParserRULE_parameterDecl
	return p
}
...
func (p *TiqParser) ParameterDecl() (localctx IParameterDeclContext) {
	...
	p.EnterRule(localctx, 18, TiqParserRULE_parameterDecl)
	p.EnterOuterAlt(localctx, 1)
	{
		p.SetState(172)
		p.Match(TiqParserIDENTIFIER)
...
func NewEmptyResultsContext() *ResultsContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = TiqParserRULE_results
	return p
}
...
func (p *TiqParser) Results() (localctx IResultsContext) {
	...
	p.EnterRule(localctx, 20, TiqParserRULE_results)
	var _la int
...
func NewEmptyEnumDefContext() *EnumDefContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = TiqParserRULE_enumDef
	return p
}
...
func (s *EnumDefContext) ENUM() antlr.TerminalNode {
	return s.GetToken(TiqParserENUM, 0)
}
...
func (p *TiqParser) EnumDef() (localctx IEnumDefContext) {
	...
	p.EnterRule(localctx, 22, TiqParserRULE_enumDef)
	var _la int

	p.EnterOuterAlt(localctx, 1)
	{
		p.SetState(183)
		p.Match(TiqParserENUM)
		if p.HasError() {
			// Recognition error - abort rule
			goto errorExit
		}
...
func NewEmptyEnumItemContext() *EnumItemContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = TiqParserRULE_enumItem
	return p
}
...
func (p *TiqParser) EnumItem() (localctx IEnumItemContext) {
	...
	p.EnterRule(localctx, 24, TiqParserRULE_enumItem)
	var _la int
...
func NewEmptyEnumValueContext() *EnumValueContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = TiqParserRULE_enumValue
	return p
}
...
func (s *EnumValueContext) INT_VALUE() antlr.TerminalNode {
	return s.GetToken(TiqParserINT_VALUE, 0)
}

func (s *EnumValueContext) STRING_VALUE() antlr.TerminalNode {
	return s.GetToken(TiqParserSTRING_VALUE, 0)
}
...
func (p *TiqParser) EnumValue() (localctx IEnumValueContext) {
	...
	p.EnterRule(localctx, 26, TiqParserRULE_enumValue)
	var _la int
	...
	p.EnterOuterAlt(localctx, 1)
	{
		...
		if !(_la == TiqParserINT_VALUE || _la == TiqParserSTRING_VALUE) {
...
func NewEmptyClassDefContext() *ClassDefContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = TiqParserRULE_classDef
	return p
}
...
func (s *ClassDefContext) CLASS() antlr.TerminalNode {
	return s.GetToken(TiqParserCLASS, 0)
}
...
func (p *TiqParser) ClassDef() (localctx IClassDefContext) {
	...
	p.EnterRule(localctx, 28, TiqParserRULE_classDef)
	var _la int

	p.EnterOuterAlt(localctx, 1)
	{
		p.SetState(203)
		p.Match(TiqParserCLASS)
		if p.HasError() {
			// Recognition error - abort rule
			goto errorExit
		}
...
func NewEmptyPropertyContext() *PropertyContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = TiqParserRULE_property
	return p
}
...
func (p *TiqParser) Property() (localctx IPropertyContext) {
	...
	p.EnterRule(localctx, 30, TiqParserRULE_property)
	p.EnterOuterAlt(localctx, 1)
	{
		p.SetState(214)
		p.Match(TiqParserIDENTIFIER)
...
func NewEmptyTypeContext() *TypeContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = TiqParserRULE_type
	return p
}
...
func (s *TypeContext) ERROR() antlr.TerminalNode {
	return s.GetToken(TiqParserERROR, 0)
}
...
func (p *TiqParser) Type_() (localctx ITypeContext) {
	...
	p.EnterRule(localctx, 32, TiqParserRULE_type)
	p.SetState(228)
	p.GetErrorHandler().Sync(p)
	if p.HasError() {
		goto errorExit
	...
	case TiqParserSTRING:
		p.EnterOuterAlt(localctx, 4)
		{
			p.SetState(220)
			p.Match(TiqParserSTRING)
			if p.HasError() {
				// Recognition error - abort rule
				goto errorExit
			}
...
func NewEmptyTimeSeriesTypeContext() *TimeSeriesTypeContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = TiqParserRULE_timeSeriesType
	return p
}
...
func (s *TimeSeriesTypeContext) TIMESERIES() antlr.TerminalNode {
	return s.GetToken(TiqParserTIMESERIES, 0)
}
...
func (p *TiqParser) TimeSeriesType() (localctx ITimeSeriesTypeContext) {
	...
	p.EnterRule(localctx, 34, TiqParserRULE_timeSeriesType)
	var _la int

	p.EnterOuterAlt(localctx, 1)
	{
		p.SetState(230)
		p.Match(TiqParserTIMESERIES)
		if p.HasError() {
			// Recognition error - abort rule
			goto errorExit
		}
...
func NewEmptyListTypeContext() *ListTypeContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = TiqParserRULE_listType
	return p
}
...
func (s *ListTypeContext) LIST() antlr.TerminalNode {
	return s.GetToken(TiqParserLIST, 0)
}
...
func (p *TiqParser) ListType() (localctx IListTypeContext) {
	...
	p.EnterRule(localctx, 36, TiqParserRULE_listType)
	p.EnterOuterAlt(localctx, 1)
	{
		p.SetState(237)
		p.Match(TiqParserLIST)
		if p.HasError() {
			// Recognition error - abort rule
			goto errorExit
		}
...
func NewEmptyMapTypeContext() *MapTypeContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = TiqParserRULE_mapType
	return p
}
...
func (s *MapTypeContext) MAP() antlr.TerminalNode {
	return s.GetToken(TiqParserMAP, 0)
}
...
func (s *MapTypeContext) COMMA() antlr.TerminalNode {
	return s.GetToken(TiqParserCOMMA, 0)
}
...
func (p *TiqParser) MapType() (localctx IMapTypeContext) {
	...
	p.EnterRule(localctx, 38, TiqParserRULE_mapType)
	p.EnterOuterAlt(localctx, 1)
	{
		p.SetState(242)
		p.Match(TiqParserMAP)
		if p.HasError() {
			// Recognition error - abort rule
			goto errorExit
		}
...
func NewEmptyKeyTypeContext() *KeyTypeContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = TiqParserRULE_keyType
	return p
}
...
func (p *TiqParser) KeyType() (localctx IKeyTypeContext) {
	...
	p.EnterRule(localctx, 40, TiqParserRULE_keyType)
	var _la int
...
func NewEmptyBlockContext() *BlockContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = TiqParserRULE_block
	return p
}
...
func (p *TiqParser) Block() (localctx IBlockContext) {
	...
	p.EnterRule(localctx, 42, TiqParserRULE_block)
	var _la int
...
func NewEmptyStatementContext() *StatementContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = TiqParserRULE_statement
	return p
}
...
func (p *TiqParser) Statement() (localctx IStatementContext) {
	...
	p.EnterRule(localctx, 44, TiqParserRULE_statement)
	p.SetState(264)
	p.GetErrorHandler().Sync(p)
	if p.HasError() {
		goto errorExit
	...
	case TiqParserTHIS, TiqParserNEW, TiqParserIDENTIFIER:
		p.EnterOuterAlt(localctx, 2)
		{
			p.SetState(261)
...
func NewEmptyVarsDeclarationContext() *VarsDeclarationContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = TiqParserRULE_varsDeclaration
	return p
}
...
func (p *TiqParser) VarsDeclaration() (localctx IVarsDeclarationContext) {
	...
	p.EnterRule(localctx, 46, TiqParserRULE_varsDeclaration)
	var _la int
...
func NewEmptyVarDeclarationContext() *VarDeclarationContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = TiqParserRULE_varDeclaration
	return p
}
...
func (s *VarDeclarationContext) COLON() antlr.TerminalNode {
	return s.GetToken(TiqParserCOLON, 0)
}
...
func (p *TiqParser) VarDeclaration() (localctx IVarDeclarationContext) {
	...
	p.EnterRule(localctx, 48, TiqParserRULE_varDeclaration)
	var _la int
	...
	if _la == TiqParserCOLON {
		{
			p.SetState(276)
			p.Match(TiqParserCOLON)
			if p.HasError() {
				// Recognition error - abort rule
				goto errorExit
			}
...
func NewEmptyVarsAssignmentOrFunctionCallContext() *VarsAssignmentOrFunctionCallContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = TiqParserRULE_varsAssignmentOrFunctionCall
	return p
}
...
func (p *TiqParser) VarsAssignmentOrFunctionCall() (localctx IVarsAssignmentOrFunctionCallContext) {
	...
	p.EnterRule(localctx, 50, TiqParserRULE_varsAssignmentOrFunctionCall)
	var _la int
...
func NewEmptyIfStatementContext() *IfStatementContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = TiqParserRULE_ifStatement
	return p
}
...
func (s *IfStatementContext) IF() antlr.TerminalNode {
	return s.GetToken(TiqParserIF, 0)
}
...
func (p *TiqParser) IfStatement() (localctx IIfStatementContext) {
	...
	p.EnterRule(localctx, 52, TiqParserRULE_ifStatement)
	var _la int
...
func NewEmptyElseIfBlockContext() *ElseIfBlockContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = TiqParserRULE_elseIfBlock
	return p
}
...
func (s *ElseIfBlockContext) ELSE() antlr.TerminalNode {
	return s.GetToken(TiqParserELSE, 0)
}
...
func (p *TiqParser) ElseIfBlock() (localctx IElseIfBlockContext) {
	...
	p.EnterRule(localctx, 54, TiqParserRULE_elseIfBlock)
	p.EnterOuterAlt(localctx, 1)
	{
		p.SetState(315)
		p.Match(TiqParserELSE)
		if p.HasError() {
			// Recognition error - abort rule
			goto errorExit
		}
...
func NewEmptyElseBlockContext() *ElseBlockContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = TiqParserRULE_elseBlock
	return p
}
...
func (p *TiqParser) ElseBlock() (localctx IElseBlockContext) {
	...
	p.EnterRule(localctx, 56, TiqParserRULE_elseBlock)
	p.EnterOuterAlt(localctx, 1)
	{
		p.SetState(320)
		p.Match(TiqParserELSE)
...
func NewEmptyReturnStatementContext() *ReturnStatementContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = TiqParserRULE_returnStatement
	return p
}
...
func (s *ReturnStatementContext) RETURN() antlr.TerminalNode {
	return s.GetToken(TiqParserRETURN, 0)
}
...
func (p *TiqParser) ReturnStatement() (localctx IReturnStatementContext) {
	...
	p.EnterRule(localctx, 58, TiqParserRULE_returnStatement)
	var _la int
...
func NewEmptyExpressionContext() *ExpressionContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = TiqParserRULE_expression
	return p
}
...
func (s *ExpressionContext) NOT() antlr.TerminalNode {
	return s.GetToken(TiqParserNOT, 0)
}
...
func (s *ExpressionContext) STAR() antlr.TerminalNode {
	return s.GetToken(TiqParserSTAR, 0)
}

func (s *ExpressionContext) SLASH() antlr.TerminalNode {
	return s.GetToken(TiqParserSLASH, 0)
}

func (s *ExpressionContext) PLUS() antlr.TerminalNode {
	return s.GetToken(TiqParserPLUS, 0)
}

func (s *ExpressionContext) MINUS() antlr.TerminalNode {
	return s.GetToken(TiqParserMINUS, 0)
}
...
func (p *TiqParser) expression(_p int) (localctx IExpressionContext) {
	...
	_startState := 60
	p.EnterRecursionRule(localctx, 60, TiqParserRULE_expression, _p)
	var _la int
	...
	switch p.GetTokenStream().LA(1) {
	case TiqParserTRUE, TiqParserFALSE, TiqParserTHIS, TiqParserNEW, TiqParserBAR, TiqParserERROR, TiqParserIDENTIFIER, TiqParserINT_VALUE, TiqParserREAL_VALUE, TiqParserSTRING_VALUE, TiqParserL_PAREN, TiqParserPLUS, TiqParserMINUS, TiqParserAPOS:
		{
			p.SetState(336)
			p.UnaryExpression()
		}
	...
	for _alt != 2 && _alt != antlr.ATNInvalidAltNumber {
		if _alt == 1 {
			...
			case 1:
				...
				p.PushNewRecursionContext(localctx, _startState, TiqParserRULE_expression)
				p.SetState(343)
				...
				}
				{
					...
					if !(_la == TiqParserSTAR || _la == TiqParserSLASH) {
						p.GetErrorHandler().RecoverInline(p)
					} else {
						p.GetErrorHandler().ReportMatch(p)
						p.Consume()
			...
			case 2:
				...
				}
				{
					...
					if !(_la == TiqParserPLUS || _la == TiqParserMINUS) {
						p.GetErrorHandler().RecoverInline(p)
					} else {
						p.GetErrorHandler().ReportMatch(p)
						p.Consume()
...
func NewEmptyUnaryExpressionContext() *UnaryExpressionContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = TiqParserRULE_unaryExpression
	return p
}
...
func (p *TiqParser) UnaryExpression() (localctx IUnaryExpressionContext) {
	...
	p.EnterRule(localctx, 62, TiqParserRULE_unaryExpression)
	var _la int
	...
	switch p.GetTokenStream().LA(1) {
	case TiqParserPLUS, TiqParserMINUS:
		p.EnterOuterAlt(localctx, 1)
		{
			p.SetState(371)
			_la = p.GetTokenStream().LA(1)
	...
	case TiqParserTRUE, TiqParserFALSE, TiqParserERROR, TiqParserINT_VALUE, TiqParserREAL_VALUE, TiqParserSTRING_VALUE, TiqParserAPOS:
		p.EnterOuterAlt(localctx, 4)
		{
			p.SetState(375)
...
func NewEmptyExpressionInParenthesisContext() *ExpressionInParenthesisContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = TiqParserRULE_expressionInParenthesis
	return p
}
...
func (p *TiqParser) ExpressionInParenthesis() (localctx IExpressionInParenthesisContext) {
	...
	p.EnterRule(localctx, 64, TiqParserRULE_expressionInParenthesis)
	p.EnterOuterAlt(localctx, 1)
	{
		p.SetState(379)
		p.Match(TiqParserL_PAREN)
...
func NewEmptyChainedExpressionContext() *ChainedExpressionContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = TiqParserRULE_chainedExpression
	return p
}
...
func (p *TiqParser) ChainedExpression() (localctx IChainedExpressionContext) {
	...
	p.EnterRule(localctx, 66, TiqParserRULE_chainedExpression)
	var _la int
	...
	switch p.GetTokenStream().LA(1) {
	case TiqParserTHIS, TiqParserIDENTIFIER:
		p.EnterOuterAlt(localctx, 1)
		p.SetState(385)
		p.GetErrorHandler().Sync(p)
		if p.HasError() {
		...
		if _la == TiqParserTHIS {
			{
				p.SetState(383)
				p.Match(TiqParserTHIS)
				if p.HasError() {
					// Recognition error - abort rule
					goto errorExit
				}
...
func NewEmptyChainItemContext() *ChainItemContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = TiqParserRULE_chainItem
	return p
}
...
func (p *TiqParser) ChainItem() (localctx IChainItemContext) {
	...
	p.EnterRule(localctx, 68, TiqParserRULE_chainItem)
	p.EnterOuterAlt(localctx, 1)
	{
		p.SetState(407)
		p.Match(TiqParserIDENTIFIER)
...
func NewEmptyParamsExpressionContext() *ParamsExpressionContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = TiqParserRULE_paramsExpression
	return p
}
...
func (p *TiqParser) ParamsExpression() (localctx IParamsExpressionContext) {
	...
	p.EnterRule(localctx, 70, TiqParserRULE_paramsExpression)
	var _la int
...
func NewEmptyAccessorExpressionContext() *AccessorExpressionContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = TiqParserRULE_accessorExpression
	return p
}
...
func (s *AccessorExpressionContext) L_BRACKET() antlr.TerminalNode {
	return s.GetToken(TiqParserL_BRACKET, 0)
}
...
func (s *AccessorExpressionContext) R_BRACKET() antlr.TerminalNode {
	return s.GetToken(TiqParserR_BRACKET, 0)
}
...
func (p *TiqParser) AccessorExpression() (localctx IAccessorExpressionContext) {
	...
	p.EnterRule(localctx, 72, TiqParserRULE_accessorExpression)
	p.EnterOuterAlt(localctx, 1)
	{
		p.SetState(427)
		p.Match(TiqParserL_BRACKET)
		if p.HasError() {
			// Recognition error - abort rule
			goto errorExit
		}
...
func NewEmptyBarExpressionContext() *BarExpressionContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = TiqParserRULE_barExpression
	return p
}
...
func (p *TiqParser) BarExpression() (localctx IBarExpressionContext) {
	...
	p.EnterRule(localctx, 74, TiqParserRULE_barExpression)
	var _la int

	p.EnterOuterAlt(localctx, 1)
	{
		p.SetState(431)
		p.Match(TiqParserBAR)
		if p.HasError() {
			// Recognition error - abort rule
			goto errorExit
		}
...
func NewEmptyListExpressionContext() *ListExpressionContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = TiqParserRULE_listExpression
	return p
}
...
func (p *TiqParser) ListExpression() (localctx IListExpressionContext) {
	...
	p.EnterRule(localctx, 76, TiqParserRULE_listExpression)
	var _la int
...
func NewEmptyMapExpressionContext() *MapExpressionContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = TiqParserRULE_mapExpression
	return p
}
...
func (p *TiqParser) MapExpression() (localctx IMapExpressionContext) {
	...
	p.EnterRule(localctx, 78, TiqParserRULE_mapExpression)
	var _la int
...
func NewEmptyKeyValueCoupleContext() *KeyValueCoupleContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = TiqParserRULE_keyValueCouple
	return p
}
...
func (p *TiqParser) KeyValueCouple() (localctx IKeyValueCoupleContext) {
	...
	p.EnterRule(localctx, 80, TiqParserRULE_keyValueCouple)
	p.EnterOuterAlt(localctx, 1)
	{
		p.SetState(459)
		p.KeyValue()
...
func NewEmptyKeyValueContext() *KeyValueContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = TiqParserRULE_keyValue
	return p
}
...
func (p *TiqParser) KeyValue() (localctx IKeyValueContext) {
	...
	p.EnterRule(localctx, 82, TiqParserRULE_keyValue)
	p.SetState(467)
	p.GetErrorHandler().Sync(p)
	if p.HasError() {
		goto errorExit
...
func NewEmptyConstantValueExpressionContext() *ConstantValueExpressionContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = TiqParserRULE_constantValueExpression
	return p
}
...
func (s *ConstantValueExpressionContext) REAL_VALUE() antlr.TerminalNode {
	return s.GetToken(TiqParserREAL_VALUE, 0)
}
...
func (p *TiqParser) ConstantValueExpression() (localctx IConstantValueExpressionContext) {
	...
	p.EnterRule(localctx, 84, TiqParserRULE_constantValueExpression)
	p.SetState(476)
	p.GetErrorHandler().Sync(p)
	if p.HasError() {
		goto errorExit
...
func NewEmptyTimeValueContext() *TimeValueContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = TiqParserRULE_timeValue
	return p
}
...
func (p *TiqParser) TimeValue() (localctx ITimeValueContext) {
	...
	p.EnterRule(localctx, 86, TiqParserRULE_timeValue)
	p.EnterOuterAlt(localctx, 1)
	{
		p.SetState(478)
		p.Match(TiqParserAPOS)
		if p.HasError() {
			// Recognition error - abort rule
			goto errorExit
		}
...
func NewEmptyDateValueContext() *DateValueContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = TiqParserRULE_dateValue
	return p
}
...
func (s *DateValueContext) AllMINUS() []antlr.TerminalNode {
	return s.GetTokens(TiqParserMINUS)
}

func (s *DateValueContext) MINUS(i int) antlr.TerminalNode {
	return s.GetToken(TiqParserMINUS, i)
}
...
func (p *TiqParser) DateValue() (localctx IDateValueContext) {
	...
	p.EnterRule(localctx, 88, TiqParserRULE_dateValue)
	p.EnterOuterAlt(localctx, 1)
	{
		p.SetState(484)
		p.Match(TiqParserAPOS)
...
func NewEmptyBoolValueContext() *BoolValueContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = TiqParserRULE_boolValue
	return p
}
...
func (s *BoolValueContext) TRUE() antlr.TerminalNode {
	return s.GetToken(TiqParserTRUE, 0)
}

func (s *BoolValueContext) FALSE() antlr.TerminalNode {
	return s.GetToken(TiqParserFALSE, 0)
}
...
func (p *TiqParser) BoolValue() (localctx IBoolValueContext) {
	...
	p.EnterRule(localctx, 90, TiqParserRULE_boolValue)
	var _la int
	...
	p.EnterOuterAlt(localctx, 1)
	{
		...
		if !(_la == TiqParserTRUE || _la == TiqParserFALSE) {
			p.GetErrorHandler().RecoverInline(p)
		} else {
			p.GetErrorHandler().ReportMatch(p)
			p.Consume()
...
func NewEmptyErrorValueContext() *ErrorValueContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = TiqParserRULE_errorValue
	return p
}
...
func (p *TiqParser) ErrorValue() (localctx IErrorValueContext) {
	...
	p.EnterRule(localctx, 92, TiqParserRULE_errorValue)
	p.EnterOuterAlt(localctx, 1)
	{
		p.SetState(494)
		p.Match(TiqParserERROR)
...
func NewEmptyFqIdentifierContext() *FqIdentifierContext {
	...
	antlr.InitBaseParserRuleContext(&p.BaseParserRuleContext, nil, -1)
	p.RuleIndex = TiqParserRULE_fqIdentifier
	return p
}
...
func (s *FqIdentifierContext) AllIDENTIFIER() []antlr.TerminalNode {
	return s.GetTokens(TiqParserIDENTIFIER)
}

func (s *FqIdentifierContext) IDENTIFIER(i int) antlr.TerminalNode {
	return s.GetToken(TiqParserIDENTIFIER, i)
}
...
func (p *TiqParser) FqIdentifier() (localctx IFqIdentifierContext) {
	...
	p.EnterRule(localctx, 94, TiqParserRULE_fqIdentifier)
	var _la int
